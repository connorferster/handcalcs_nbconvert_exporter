...
# -*- coding: utf-8 -*-
#
# handcalcs_nbconvert_exporter documentation build configuration file, created by
...
project = 'handcalcs_nbconvert_exporter'
copyright = '2021, Tim Paine, Connor Ferster'
...
_version_py = os.path.join('..', 'handcalcs_nbconvert_exporter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'handcalcs_nbconvert_exporterdoc'
...
latex_documents = [
    (master_doc, 'handcalcs_nbconvert_exporter.tex', 'handcalcs_nbconvert_exporter Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'handcalcs_nbconvert_exporter', 'handcalcs_nbconvert_exporter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'handcalcs_nbconvert_exporter', 'handcalcs_nbconvert_exporter Documentation',
     author, 'handcalcs_nbconvert_exporter', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    handcalcs_nbconvert_exporter_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'handcalcs_nbconvert_exporter'))
    ...
    subprocess.check_call([cmd_path,
                           ...
                           '-o',
                           out_dir,
                           handcalcs_nbconvert_exporter_dir,
                           '--force'])
